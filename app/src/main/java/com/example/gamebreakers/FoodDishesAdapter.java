...
public class FoodDishesAdapter extends ArrayAdapter<String> {

    Context mContext;
    int mLayoutResId;
    String mData[] = null;

    public FoodDishesAdapter(Context context, int resource, String[] objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null){
            ...
            holder.nameView = (TextView) row.findViewById(R.id.foodDishesName);
    ...
    View.OnClickListener PopupListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            String fdd = mData[viewPosition];
            Toast.makeText(getContext(),fdd, Toast.LENGTH_SHORT).show();
        }
    };
