...
public class Activity_Current_Orders extends Activity {

    DatabaseHelper myDb;
    TextView mTextView;
    ListView mListView;
    Adapter_Current_Orders mAdapterCurrentOrders;
    Button backButton;
    String[] strings;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapterCurrentOrders = new Adapter_Current_Orders(getApplicationContext(),R.layout.row_current_orders,strings);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, final int position, long id) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Activity_Current_Orders.this);
                ...
                mBuilder.setTitle("Choose an Action: ").setItems(R.array.Array_currentOrder, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(which == 0){
                                    ...
                                    if(deletedRows > 0)
                                        Toast.makeText(Activity_Current_Orders.this,"Order Completed",Toast.LENGTH_LONG).show();
                                    else
                                        Toast.makeText(Activity_Current_Orders.this,"Order not Completed",Toast.LENGTH_LONG).show();
                                    ...
                                    Integer deletedRows = myDb.deleteArrayData(strings[position],stallNameMessage);
                                    if(deletedRows > 0)
                                        Toast.makeText(Activity_Current_Orders.this,"Order Canceled",Toast.LENGTH_LONG).show();
                                    else
                                        Toast.makeText(Activity_Current_Orders.this,"Order not Canceled",Toast.LENGTH_LONG).show();
