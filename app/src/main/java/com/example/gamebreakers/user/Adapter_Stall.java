...
public class Adapter_Stall extends ArrayAdapter<Stall> {

    Context mContext;
    int mLayoutResId;
    Stall mData[] = null;

    public Adapter_Stall(Context context, int resource, Stall[] objects) {
    ...
    @Override
    public Stall getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Stall details_stall = mData[position];
        ...
        holder.nameView.setText(details_stall.getStallName());
    ...
    View.OnClickListener PopupListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Stall details_stall = mData[viewPosition];
            Toast.makeText(getContext(),details_stall.getStallName(), Toast.LENGTH_SHORT).show();
        }
    };
